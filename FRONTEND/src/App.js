...
function App() {
  ...
  return (
    <div className="App bg-gradient-to-b from-zinc-900 to-zinc-950 text-white flex flex-col items-center justify-center min-h-screen">
